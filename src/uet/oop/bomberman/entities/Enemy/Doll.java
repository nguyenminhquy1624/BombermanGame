...
public class Doll extends Enemy {
    public Doll(int x, int y, Image img, int speed) {
        super(x, y, img, speed);
    }
...
//        }
    ...
    public void moveLeft() {
        ...
        up = 0;
        down = 0;
        img = Sprite.movingSprite(Sprite.doll_left1, Sprite.doll_left2, Sprite.doll_left3, left, animate).getFxImage();
    ...
    public void moveRight() {
        ...
        up = 0;
        down = 0;
        img = Sprite.movingSprite(Sprite.doll_right1, Sprite.doll_right2, Sprite.doll_right3, right, animate).getFxImage();
    ...
    public void moveUp() {
        ...
        right = 0;
        down = 0;
        img = Sprite.movingSprite(Sprite.doll_left1, Sprite.doll_left2, Sprite.doll_left3, up, animate).getFxImage();
        if(up < animate) up++;
        else up = 1;
        if(canMove(3))
            y -= speed;
    ...
    public void moveDown() {
        ...
        right = 0;
        up = 0;
        img = Sprite.movingSprite(Sprite.doll_right1, Sprite.doll_right2, Sprite.doll_left3, down, animate).getFxImage();
