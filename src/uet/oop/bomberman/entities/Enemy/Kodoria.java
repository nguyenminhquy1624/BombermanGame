...
public class Kodoria extends Enemy{
    public Kodoria(int x, int y, Image img, int speed) {
        super(x, y, img, speed);
    }
...
//        }
        if(direction == 1) {
            if(y%32 == 0) {
                ...
                if(ans) {
                    if(speed == 1) {
                        if(BombermanGame.board.getEntityAt(x-speed, y) != null
        ...
        if(direction == 2) {
            if(y%32 == 0) {
                ...
                if(ans) {
                    if(speed == 1) {
                        if(BombermanGame.board.getEntityAt(x + Sprite.SCALED_SIZE-1 + speed, y) != null
        ...
        if(direction == 3) {
            if(x%32 == 0) {
                ...
                if(ans) {
                    if(speed == 1) {
                        if( BombermanGame.board.getEntityAt(x, y - speed) != null
        ...
        if(direction == 4) {
            if(x%32 == 0) {
                ...
                if(ans) {
                    if(speed == 1) {
                        if(BombermanGame.board.getEntityAt(x, y + Sprite.SCALED_SIZE-1 + speed) != null
    ...
    public void moving() {
        if(x%32 == 0 && y%32 == 0)
            currentDirection = AI.chooseDirectionAdvance(this);
    ...
    public void moveLeft() {
        ...
        up = 0;
        down = 0;
        img = Sprite.movingSprite(Sprite.kondoria_left1, Sprite.kondoria_left2, Sprite.kondoria_left3, left, animate).getFxImage();
    ...
    public void moveRight() {
        ...
        up = 0;
        down = 0;
        img = Sprite.movingSprite(Sprite.kondoria_right1, Sprite.kondoria_right2, Sprite.kondoria_right3, right, animate).getFxImage();
    ...
    public void moveUp() {
        ...
        right = 0;
        down = 0;
        img = Sprite.movingSprite(Sprite.kondoria_left1, Sprite.kondoria_left2, Sprite.kondoria_left3, up, animate).getFxImage();
        if(up < animate) up++;
        else up = 1;
        if(canMove(3))
            y -= speed;
    ...
    public void moveDown() {
        ...
        right = 0;
        up = 0;
        img = Sprite.movingSprite(Sprite.kondoria_right1, Sprite.kondoria_right2, Sprite.kondoria_left3, down, animate).getFxImage();
